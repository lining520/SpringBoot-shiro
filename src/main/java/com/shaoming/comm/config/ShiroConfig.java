...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager){
        ...
        filterChainDefinitionMap.put("/v1/web/sysUser/code", "anon");
        filterChainDefinitionMap.put("/v1/web/sysUser/verification/code", "anon");
        filterChainDefinitionMap.put("/v1/web/sysUser/addSysUser", "anon");
        // 配置APP接口不被拦截
