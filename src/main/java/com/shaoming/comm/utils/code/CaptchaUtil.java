...
public class CaptchaUtil {
    ...
    private final static String RDEIS_REDIS = "code_redis";
     ...
     * @throws IOException IO异常
     */
    public static void out(int len)
            throws IOException {
        out(130, 48, len);
    }
     ...
     * @throws IOException IO异常
     */
    public static void out(int len, Font font)
            throws IOException {
        out(130, 48, len, font);
    }
     ...
     * @throws IOException IO异常
     */
    public static void out(int width, int height, int len)
            throws IOException {
        out(width, height, len, null);
    }
     ...
     * @throws IOException IO异常
     */
    public static void out(int width, int height, int len, Font font)
            throws IOException {
        outCaptcha(width, height, len, font, 1);
    }
    ...
    public static void outPng(int width, int height, int len, Font font, HttpServletRequest request, HttpServletResponse response)
            throws IOException {
        outCaptcha(width, height, len, font, 0);
    }
    ...
    private static void outCaptcha(int width, int height, int len, Font font, int cType)
       ...
       // redisTemplate.boundValueOps("code").set(captcha.text().toLowerCase());//string
        //captcha.out(response.getOutputStream());
       // CacheManager cacheManager=new CacheManager().getCache("asd");
        //Cache cache = CacheManager.getCache(RDEIS_REDIS);
