...
//        float m = (width-(strs.length*font.getSize()))/strs.length;
//        float x = m/2;//字符的x坐标
//        g2d.setFont(font);
//        for (int i = 0; i < strs.length; i++) {
//            AlphaComposite ac = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, getAlpha(flag, i));
//            g2d.setComposite(ac);
//            g2d.setColor(fontcolor[i]);
//            g2d.drawOval(Randoms.num(width), Randoms.num(height), Randoms.num(5,30), 5 + Randoms.num(5,30));//绘制椭圆边框
//            g2d.drawString(strs[i] + "",x+(font.getSize()+m)*i+0,y);
//        }
